...
gauss(4,:)=gauss(4,:)+gauss(2,:);                   % Dördüncü adım 3.satır ile 4.satırı topladım.

gauss(4,:)=gauss(4,:)+gauss(3,:);                   % Beşinci adım 3.satır ile 4.satırı topladım.

gauss(3,:)=-gauss(3,:);                             % Altıncı adım 3.satırı negatif yaptım.
