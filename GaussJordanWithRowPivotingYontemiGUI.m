function varargout = GaussJordanWithRowPivotingYontemiGUI(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GaussJordanWithRowPivotingYontemiGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @GaussJordanWithRowPivotingYontemiGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GaussJordanWithRowPivotingYontemiGUI_OpeningFcn(hObject, eventdata, handles, varargin)

handles.output = hObject;

guidata(hObject, handles);

function varargout = GaussJordanWithRowPivotingYontemiGUI_OutputFcn(hObject, eventdata, handles) 
...
gauss(4,:)=gauss(4,:)+gauss(2,:);                   % Dördüncü adým 3.satýr ile 4.satýrý topladým.

gauss(4,:)=gauss(4,:)+gauss(3,:);                   % Beþinci adým 3.satýr ile 4.satýrý topladým.

gauss(3,:)=-gauss(3,:);                             % Altýncý adým 3.satýrý negatif yaptým.
